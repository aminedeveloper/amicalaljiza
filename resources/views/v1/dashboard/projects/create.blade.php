    ...
    <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <select class="form-select" name="category" data-control="select2" required
                    data-placeholder="Selecter une category">
                    <option></option>
            ...
            <div class="col-12 mt-3">
                ...
                <select class="form-select" name="tranche" data-control="select2" required
                    data-placeholder="Selecter une tranche">
                    <option></option>
