        ...
        <div class="card-header border-0 pt-6">
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{route('admin.albums.create')}}" type="button" class="btn btn-primary">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                           @foreach ($albums as $album )
                                ...
                                <td>{{date('d-m-Y', strtotime($album->created_at))}}</td>
                                 <td>
                                        <a href="{{ route('admin.albums.edit',$album->id) }}" class=" btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
