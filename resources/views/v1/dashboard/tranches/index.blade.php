        ...
        <div class="card-header border-0 pt-6">
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{route('admin.tranches.create')}}" type="button" class="btn btn-primary">
                               ...
                               <tr>
                                  <td>
                                   ...
                                   <td>
                                        ...
                                        <form style="display:inline-block" method="POST" action="{{ route('admin.tranches.destroy',$tranche->id) }}">
                                           @csrf
                                           @method('DELETE')
